...
<html lang="en">
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MjU4NjU5OTU4OjZkZGZkNWJjNzdiM2M5MmNmNWUxODA3YTk2MDVmMmQ0ZGY4NDJmOGM0YTMwMTZlZDFmNzFmZjM2OGUwYjY0NmE=--c21090777f9a6a1d3e779f61e9bfcd4087bc4c22">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="E45E:32AE:F2F625:15D856C:5AD88FA3" data-pjax-transient>
...
<meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="js-proxy-site-detection-payload" content="ZGExZjUwMzE1OGE5YWFkMzU1NzMxMmYxMmQxY2ZlYWE1NmI2MDIyN2JhYTU3YmEyNTcwNjA2ZWRmNmQyM2Y4N3x7InJlbW90ZV9hZGRyZXNzIjoiMTI1LjExOS41LjI0MSIsInJlcXVlc3RfaWQiOiJFNDVFOjMyQUU6RjJGNjI1OjE1RDg1NkM6NUFEODhGQTMiLCJ0aW1lc3RhbXAiOjE1MjQxNDE5OTEsImhvc3QiOiJnaXRodWIuY29tIn0=">
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown js-menu-container">
    ...
    <details class="dropdown-details details-reset js-dropdown-details d-flex pl-2 flex-items-center">
      ...
      <ul class="dropdown-menu dropdown-menu-sw">
        ...
        <li><!-- '"` --><!-- </textarea></xmp> --></option></form><form class="logout-form" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="j1ykax+0/xibTpgv4cmdC9FaV9zobZvhVr37uwl3e9+FlFcyYyD9vrqz+G+opn/e+vdshJFNQNCHjWVlvbJzOQ==" />
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="sr-only right-0" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="aM0KYpfh8IgaPb19b811TKT5euLFBQezc5UEqr2A8a1iBfk763XyLjvA3T0mopeZj1RBurwl3IKipZp0CUX5Sw==" />
          <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
            Sign out
          </button>
</form>      </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form data-autosubmit="true" data-remote="true" class="js-social-container" action="/notifications/subscribe" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="WKyFlq06vS3kFuZJJXDwuPy2HDq6zd98Vh8ZoRJxYC3ZFaLkVP7bPzJnTwsX+M1CcS5tZcCrbmaEPIdBUf/p4w==" />      <input type="hidden" name="repository_id" id="repository_id" value="97216102" class="form-control" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="starred js-social-form" action="/gitalk/gitalk/unstar" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="NsFBRzzdtYBrd2cBugueZHCTRlChKX9hnCuKX+hkdML1evntiomIuhe8mtOPN0TIctWjgoQReEvEklFTlkN9zQ==" />
      ...
      <button
        ...
        <a class="social-count js-social-count" href="/gitalk/gitalk/stargazers"
           aria-label="998 users starred this repository">
          998
        </a>
</form>
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="unstarred js-social-form" action="/gitalk/gitalk/star" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="cy6zFwhTYjiU8S+7qGNigM/JzZt/6anyqSymrI6ihB+7afVGLfZb1+ZHycFrDXLCiYYLect5CsqWMMiLFiAhVQ==" />
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="btn-with-count" action="/gitalk/gitalk/fork" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="DYNcGgLvhyNixhzYv7NUKJ2UAh7/N2c5JnencDZS77cRDgkVB7rBchSnlgrnkHhtSiQbMHTQAz2plqvInH7QNA==" />
            <button
                type="submit"
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.44933s from unicorn-1415737396-smlbj">GitHub</span>, Inc.</li>
